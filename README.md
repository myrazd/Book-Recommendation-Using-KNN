...
• Data Preprocessing: Filtering users and books based on rating frequency and constructing a clean user–book interaction matrix. <br>
• Model Training: Applying KNN with cosine similarity on a sparse matrix representation of the dataset. <br>
• Recommendation System: Retrieving the top 5 most similar books for a given title based on nearest neighbour distances. <br>
